...
сид. Построено `scripts/make_figures.py` из закоммиченных данных.* Замена цепочки рёбер на один надёжный запрос до цели
...
Это важно именно потому, что рёбра здесь лучшие из доступных. Нельзя сказать,
будто композиция проиграла из-за плохих оценок: их улучшили настолько,
насколько метод позволяет, и вклад композиции остался столь же отрицательным.
