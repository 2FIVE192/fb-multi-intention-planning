...
* ~~**Насколько важна именно Дейкстра.**~~ Вопрос закрыт замером (5.6): Дейкстра
  не просто не нужна, она вредна — 0.47 против 0.69 у плана из одной подцели.
  Причина в том, что стоимость пути складывается из шумных рёбер, а поиск
  минимума систематически выбирает самую оптимистичную ошибку.
