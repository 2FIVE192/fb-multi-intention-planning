...
Набор состояний на локацию в замере выше собирался по координатам — это
привилегированная информация, в методе так делать нельзя. Открытый вопрос:
существует ли группировка состояний по локациям, использующая только
оффлайн-данные и FB. Проверяются кластеризация в пространстве `B` и окна
траекторий; результат — в разделе 5.5.
